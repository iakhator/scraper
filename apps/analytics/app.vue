...
function connectWebSocket() {
  try {
    ...
    if (!wsUrl || !import.meta.client) return
...
function viewContent(jobId) {
  // You can implement this to show scraped content
  console.log('View content for job:', jobId)
  alert('Content viewing feature - to be implemented')
}
...
async function fetchExistingJobs() {
  try {
    ...
    // Subscribe to updates for all existing jobs
