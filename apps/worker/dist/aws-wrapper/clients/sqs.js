...
async function sendMessage(message) {
    try {
        ...
        logger_1.default.error("Failed to send SQS message", {
            error,
            queueUrl: message.url,
        });
...
async function receiveMessages(params) {
    ...
    try {
        ...
        logger_1.default.debug("Messages received", {
        ...
        logger_1.default.error("Failed to receive SQS messages", {
            error,
            queueUrl: config_1.config.queueUrl
        });
...
async function deleteMessage(params) {
    ...
    try {
        ...
        logger_1.default.debug("Message deleted successfully", {
            receiptHandle: params.ReceiptHandle,
            queueUrl: params.QueueUrl
        });
    }
    catch (error) {
        logger_1.default.error("Failed to delete SQS message", {
            error,
            queueUrl: params.QueueUrl,
            receiptHandle: params.ReceiptHandle
        });
